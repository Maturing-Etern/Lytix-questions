        ...
        questions: [
          {
            ...
            type: "input",
            required: true,
            placeholder: "如 网易云 / SoundCloud / BiliBili / Google Drive 链接",
            text: "请提供一首您的原创音乐 Demo 链接（时长 1–5 分钟）",
            hint: "作品须为本人原创，不得使用他人素材（采样除外并需注明）；请确保链接可正常访问",
          },
          {
            id: "c_demo_desc",
            type: "textarea",
        ...
        questions: [
          {
            ...
            type: "input",
            required: true,
            placeholder: "如 Google Drive / 百度网盘 / WeTransfer / GitHub 链接",
            text: "请提供命题曲目谱面文件的下载链接（支持 .json / .xml / .zip）",
            hint: "命题音频将另行提供；请基于所给音频制作 EASY + HARD 两个难度；请确保链接可正常访问",
          },
          {
            id: "ch_design",
            type: "textarea",
          ...
          },
          {
            ...
            type: "input",
            required: false,
            placeholder: "如 BiliBili / YouTube / Google Drive 视频链接",
            text: "【选做】提供谱面游玩视频链接（有助于审核员快速预览）",
            hint: "可上传至 B站/YouTube 后贴链接，或使用网盘分享",
          },
        ],
      },
      {
